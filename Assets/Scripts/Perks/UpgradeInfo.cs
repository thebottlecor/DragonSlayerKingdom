...
[CreateAssetMenu(fileName = "UpgradeInfo", menuName = "GameInfos/UpgradeInfo")]
public class UpgradeInfo : ScriptableObject
{
    ...
    [Space(5f)]
    public List<PerkInfo> needResearch;
    [Space(5f)]
    ...
    public UpgradeEffect AddEffect(UpgradeEffect global)
    {

        UpgradeEffect temp = new UpgradeEffect
        {
